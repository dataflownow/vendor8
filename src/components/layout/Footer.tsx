      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8 xl:col-span-1">
            <div className="flex items-center">
              <div className="h-10 w-10 bg-vendor8-500 rounded-md flex items-center justify-center text-white font-bold mr-2">
                8
              </div>
              <span className="text-xl font-bold text-vendor8-800">vendor8</span>
            </div>
            <p className="text-gray-500 text-sm">
              Streamlined mobile ordering for food vendors at events - no app required.
            </p>
            ...
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                ...
                <ul className="mt-4 space-y-4">
                  ...
                  <li>
                    <Link to="/vendor" className="text-base text-gray-500 hover:text-gray-900">
                      Vendor Dashboard
                    </Link>
                  </li>
                  <li>
        ...
        <div className="mt-12 border-t border-gray-200 pt-8">
          <p className="text-base text-gray-400 xl:text-center">
            &copy; 2025 vendor8. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
